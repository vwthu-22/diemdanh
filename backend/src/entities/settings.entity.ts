...
export class Settings {
  ...
  // Morning session
  @Column({ name: 'morning_start', default: '07:30' })
  morningStart: string;

  @Column({ name: 'morning_on_time_end', default: '07:45' })
  morningOnTimeEnd: string;

  @Column({ name: 'morning_late_end', default: '08:15' })
  morningLateEnd: string;

  // Afternoon session
  @Column({ name: 'afternoon_start', default: '13:00' })
  afternoonStart: string;

  @Column({ name: 'afternoon_on_time_end', default: '13:15' })
  afternoonOnTimeEnd: string;

  @Column({ name: 'afternoon_late_end', default: '13:45' })
